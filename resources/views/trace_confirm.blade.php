...
<table id="cart" class="table table-hover table-condensed container">
    ...
    <tbody>
        ...
        @foreach($extra_charge as $charge)
            ...
            <tr>
                ...
                <td style="text-align:center"></td>
                <td style="text-align:center">Rp. {{$charge->price}}</td>
    ...
    <tr>
        ...
        @endphp
            <td colspan="4" class="text-right"><h6><strong>Total Rp. {{ $without_discount_price }}</strong></h6></td>
        </tr>
        <tr>
        @php 
        ...
        @endphp
            <td colspan="4" class="text-right"><h6><strong>Discount Rp. {{ $discount_price }}</strong></h6></td>
        </tr>
        <tr>
        @php 
        ...
        @endphp
            <td colspan="4" class="text-right"><h3><strong>Total (With Discount)Rp. {{ $total_price }}</h2></strong></h3></td>
        </tr>
        <tr>
